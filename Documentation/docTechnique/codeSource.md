...
/**
 * Permet d'effectuer la connexion à la base de donnée
 *
 */
function tennis_database()
{
  static $dbc = null;
...
```php
<?php
require_once "asset/php/constantes.inc.php";
require_once "asset/php/function.inc.php";
require_once "asset/php/database.php";
``` 
...
/*
pour mettre le footer en bas de page
*/
